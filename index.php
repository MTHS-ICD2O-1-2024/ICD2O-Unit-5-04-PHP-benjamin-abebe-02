    ...
    <main class="mdl-layout__content">
      ...
      <form action="./answer.php" method="get">
        <div class="mdl-textfield mdl-js-textfield">
          <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="user-age" name="age" />
          <label class="mdl-textfield__label" for="demo-input">age</label>
          <span class="mdl-textfield__error">Input is not a number</span>
          </br>
        </div>
          <div class="mdl-textfield mdl-js-textfield">
            <input class="mdl-textfield__input" type="text" id="user-day" name="day" />
            <label class="mdl-textfield__label" for="demo-input">day</label>
            <span class="mdl-textfield__error">Input is not a proper date</span>
          </div>
          </br>
